...
public class categoryadapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public categoryadapter(Context mContext,List<T> productLists) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof EventViewHolder){
            ...
            ((categoryadapter.EventViewHolder) holder).title.setText(((categoryListModel.Result)dataItem).getName());
